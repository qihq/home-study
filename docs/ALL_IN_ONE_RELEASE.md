...
```sh
sha256sum -c family-learning-ds918plus-amd64-20260715-camera-ocr.tar.sha256
docker load -i family-learning-ds918plus-amd64-20260715-camera-ocr.tar
docker compose up -d
```
